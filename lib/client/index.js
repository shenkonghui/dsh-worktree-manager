  ...
  function ProjectRowItem({ group, onToggle, onCreate, actions, drag, home, t }) {
    ...
    const ownRow = (0, react_jsx_runtime.jsxs)("div", {
      ...
      children: [
        ...
        worktreeNested && worktreeBranchDecoration !== void 0 ? (0, react_jsx_runtime.jsx)(ManagedWorktreeIdentity, { decoration: { branch: worktreeBranchDecoration, ariaLabel: worktreeBranchDecoration } }) : (0, react_jsx_runtime.jsx)("span", {
...
function ManagedOfficialWorkspaceBrowser(props) {
  ...
  const projectedWorkspaceState = (0, import_react2.useMemo)(() => ({
    ...
    items: projection.workspaces.map((workspace) => {
      ...
      return branch === void 0 ? workspace : { ...workspace, __dshWorktreeManagerBranch: branch };
    })
