...
function useTopology(sessionKey, workspaceKey) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const refresh = (force) => {
      const now = Date.now();
      if (!force && now - lastFetch < 2e3) return;
      lastFetch = now;
...
var uiZh = {
  ...
  dropdown: {
    ...
    reposSummary: "{repos} \u4E2A\u4ED3\u5E93 \xB7 {worktrees} \u4E2A worktree",
    // 「视图选项」菜单项
...
var uiEn = {
  dropdown: {
    ...
    reposSummary: "{repos} repos \xB7 {worktrees} worktrees",
    // 「视图选项」菜单项
  ...
  changes: {
    ...
    subCommitHint: "Click to view the files changed by this commit",
...
var UI = navigator.language.startsWith("zh") ? uiZh : uiEn;
function format(template, params) {
  return template.replace(/\{(\w+)\}/g, (_m, name) => {
    const value = params[name];
    return value === void 0 ? `{${name}}` : String(value);
  });
}
...
function commitLineStyle(selected) {
  return {
    ...commitLine,
    cursor: "pointer",
    borderRadius: "4px",
...
function relTime(ms) {
  ...
  if (diff < 24 * 60 * minute) return `${Math.floor(diff / 36e5)} ${UI.changes.hoursAgo}`;
  if (diff < 30 * 864e5) return `${Math.floor(diff / 864e5)} ${UI.changes.daysAgo}`;
...
function SubmoduleHead({ sub, badge }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: subHeader, title: sub.path, children: [
    ...
    sub.newCommits && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: subBadge, children: UI.changes.newCommits }),
...
function WorktreeDetail(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    props.data.submodules.map((sub) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: subBody, children: sub.files.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(FileRows, { files: sub.files, sub: sub.path, selected: props.selected, onSelect: props.onSelect }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: sub.newCommits ? UI.changes.subNoFileChange : UI.changes.noChanges }) })
    ] }, sub.path)),
    fileCount === 0 && subCount === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.clean })
  ] });
}
function CommitDetail(props) {
  const [subCommit, setSubCommit] = (0, import_react4.useState)(null);
  const [subDetail, setSubDetail] = (0, import_react4.useState)({ phase: "loading" });
  const path = props.path;
  (0, import_react4.useEffect)(() => {
    if (subCommit === null || path === void 0) return;
    let cancelled = false;
    setSubDetail({ phase: "loading" });
    void (async () => {
      try {
        const data = await apiGet("commit", {
          path,
          hash: subCommit.hash,
          sub: subCommit.sub
        });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    props.detail.submodules.map((sub) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: subHeader, title: sub.path, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: sub.name }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: subBadge, children: UI.changes.pointerCommits })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: subBody, children: [
        sub.commits.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { style: list, children: sub.commits.map((line) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "li",
            {
              ...
              onClick: () => {
                setSubCommit((prev) => active ? null : { sub: sub.path, hash });
              },
              children: line
            },
            line
          );
        }) }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.subUnavailable }),
        subCommit !== null && subCommit.sub === sub.path && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: detailBox, children: [
          subDetail.phase === "loading" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.loading }),
          subDetail.phase === "error" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: errorNote, children: [
            UI.changes.error,
            "\uFF1A",
            subDetail.message
          ] }),
          subDetail.phase === "ready" && (subDetail.data.files.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(FileRows, { files: subDetail.data.files, sub: subCommit.sub, hash: subCommit.hash, selected: props.selected, onSelect: props.onSelect }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.noChanges }))
        ] })
      ] })
    ] }, sub.path)),
    props.detail.files.length === 0 && props.detail.submodules.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.noChanges })
  ] });
}
function ChangesView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: view, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: toolbar, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", style: refreshBtn, onClick: refresh, children: UI.changes.refresh })
    ] }),
    history.phase === "loading" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.loading }),
    notRepo && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.notRepo }),
    ...
    history.phase === "ready" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: panes, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("ul", { style: { ...list, ...listPane }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "li",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: entryTitle, children: UI.changes.worktree }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: entryMeta, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: worktreeData !== void 0 ? format(UI.changes.nChanges, { n: worktreeCount }) : "" }) })
            ]
          }
        ),
        selected?.kind === "worktree" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: detailBox, children: [
          worktree.phase === "loading" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.loading }),
        ...
        commits.map((commit) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("li", { children: [
          ...
          selected?.kind === "commit" && selected.hash === commit.hash && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: detailBox, children: [
            commitDetail.phase === "loading" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.loading }),
            commitDetail.phase === "error" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: errorNote, children: [
              UI.changes.error,
              "\uFF1A",
              commitDetail.message
            ] }),
            commitDetail.phase === "ready" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(CommitDetail, { path: cwd, detail: commitDetail.data, hash: commit.hash, selected: selectedFile, onSelect: setSelectedFile })
          ] })
        ] }, commit.hash))
      ] }),
      selectedFile !== null && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: diffPane, children: [
        ...
        fileDiff.phase === "loading" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.loading }),
        fileDiff.phase === "error" && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: errorNote, children: [
          UI.changes.error,
          "\uFF1A",
          fileDiff.message
        ] }),
        fileDiff.phase === "ready" && (fileDiff.data.diff !== "" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("pre", { style: diffBody, children: fileDiff.data.diff.split("\n").map((line, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: diffLineStyle(line), children: line }, i)) }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: note, children: UI.changes.noChanges }))
      ] })
    ] })
  ] });
}
...
async function showWorktreeDropdown(trigger) {
  ...
  let topology;
  try {
    topology = await apiGet("topology");
  } catch (err) {
  ...
  const containsRepo = (path, repo) => path === repo.root || path.startsWith(repo.root + "/");
  const currentRepoRoot = currentWs !== null ? topology.repos.find((r) => containsRepo(currentWs.path, r))?.root ?? null : null;
  const targetRepos = currentRepoRoot !== null ? topology.repos.filter((r) => r.root === currentRepoRoot) : currentWs === null ? topology.repos : [];
  ...
  const rowsOf = (repo) => [
    ...
    ...repo.worktrees.map((wt) => ({
      path: wt.path,
      ...wt.branch === void 0 ? {} : { branch: wt.branch },
      main: false,
      ...
      for (const row of filtered) {
        ...
        if (!row.main) {
          ...
          removeBtn.onclick = async (e) => {
            ...
            try {
              await apiPost("remove", { worktreePath: row.path });
              window.dispatchEvent(new Event(WORKTREE_REFRESH_EVENT));
